...
- [`docs/relay.md`](docs/relay.md), the self-hosted relay: `phoebe relay serve`, its four environment variables, the Google client, the allowlist, and the `phoebe relay init` scaffold that stands it up with TLS.
