...
export const BRIDGE_CHANNELS = {
  ...
  installsUpdate: "phoebe:installs/update",
  ...
  logsEnded: "phoebe:logs/ended",
  updateState: "phoebe:updates/state",
  updateDownload: "phoebe:updates/download",
  updateRestart: "phoebe:updates/restart",
