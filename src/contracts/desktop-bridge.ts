...
// drive them (#555); the remote arm is the relay passthrough, which starts
// answering once #554's device sign-in has put a token behind it. The local
// read loop joins the two with #556.
