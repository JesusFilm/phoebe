...
// with the reconcile watch (bootstrap/supervise-fleet.ts): a config or ref
// change drains and respawns in place. Every other invocation delegates to the engine
