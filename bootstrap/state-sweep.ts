...
// config> --json`), for the same reason enumeration does: what a pipeline owns on
...
/**
 * Which of the two triggers ran this sweep: facility boot before any pipeline
 * spawns, or a pipeline-set change once the pipelines it took down have drained. There is
 * no third — the sweep is never periodic.
 */
export type StateSweepTrigger = "boot" | "pipeline-change";
